...
public class GlobalExceptionHandler {
	...
	/**
	 * Method handles MultipleEngiConnectException that may be thrown during the execution of HTTP request
	 * @param exception the instance of MultipleEngiConnectException that has been thrown.
	 * @return ResponseEntity<ErrorResponse> this is the HTTP response containing the details of the exception that was handled
	 */
	@ExceptionHandler(MultipleEngiConnectException.class)
	public ResponseEntity<ErrorResponse> handleMultipleEngiConnectExceptions(MultipleEngiConnectException exception) {
		ErrorResponse errorResponse = new ErrorResponse();
