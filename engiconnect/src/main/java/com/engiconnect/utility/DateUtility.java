...
public class DateUtility {
	...
	/**
	 * Autowired configuration object to access application properties related to EngiConnect account settings.
	 */
	@Autowired
	...
	public int getDaysLeftForRecovery(User user) {
		...
		int daysLeft = engiConnectProperties.getDaysUntilDeletion() - daysSinceDeletion;
	...
	public int getDaysLeftForConfirmAccount(User user) {
		...
		int daysLeft = engiConnectProperties.getDaysForEmailConfirmation() - daysSinceCreation;
