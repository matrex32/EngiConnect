...
public class JwtService {
	...
	/**
     * Instance of EngiConnectPorpertiesConfig to get the secret key
     */
	@Autowired
	...
	private String generateToken(Map<TokenClaim, Object> claims) {
		SecretKey key = Keys.hmacShaKeyFor(Decoders.BASE64.decode(engiConnectProperties.getSecretKey()));
