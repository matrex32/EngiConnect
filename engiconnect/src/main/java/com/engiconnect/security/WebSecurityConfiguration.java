...
public class WebSecurityConfiguration {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(authz->authz
				.requestMatchers("/api/users/register", "/app/**", "/img/**", "/api/users/me", "/api/users/confirm", "/api/users/email-reset-password", "/reset-password", "/api/users/redirect-reset-password", "/api/users/reset-user-password", "/uploads/**", "/cv/**").permitAll()
