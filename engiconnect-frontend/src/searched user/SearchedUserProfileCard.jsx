...
import SearchedUserGeneralDetails from './SearchedUserGeneralDetails.jsx';
import '../css/BackgroundCard.css'

function SearchedUserProfileCard() {
...
export default SearchedUserProfileCard